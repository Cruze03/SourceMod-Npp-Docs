...
## Npp Exec
- Plugins > Plugins Admin > Npp Exec
- F6 > Npp Exec Script.txt > Save > Ok
- Plugins > Npp Exec > Advanced Options. Colors given in nppexec_colors.png
